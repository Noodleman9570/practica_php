...
class UserModel extends Model implements Imodel{
    ...
    {
        try {
            $query = $this->prepare('INSERT INTO users(email, password, role, budget, photo, name) VALUES(:email, :password, :role, :budget, :photo, :name)');
            $query->execute([
                'email' => $this->email,
    ...
    {
        try {
            $query = $this->prepare('UPDATE users SET usernmae = :email, password = :password, budget = :budget, photo = :photo, name = :name WHERE id = :id');
            $query->execute([
                'id' => $this->id,
                'email' => $this->email,
                'password' => $this->password,
